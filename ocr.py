"""User-facing wrapper for the standalone OCR stage."""
...
from src.pipeline_config import normalize_program
from src.run_pipeline import parse_pages, run_ocr
...
def main() -> None:
    ...
    input_dir = BASE_DIR / "inputs" / prefix
