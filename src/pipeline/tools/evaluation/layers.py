...
from src.pipeline.tools.evaluation.evaluate import calculate_cer, calculate_wer
...
def run_dual_evaluation(
    ...
    consolidated_root: Path = Path("data/output/consolidated"),
    llm_root: Path = Path("data/output/final"),
