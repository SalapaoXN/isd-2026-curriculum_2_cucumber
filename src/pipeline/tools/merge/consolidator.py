...
from src.pipeline.tools.extraction.engine import (
    DEFAULT_COOP_PAIRS,
    CurriculumExtractor,
...
from src.pipeline.config import plan_label
...
def merge_consecutive_files(
    input_dir: str = "data/output/extracted",
    output_dir: str = "data/output/consolidated",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-o",
        "--output-dir",
        default="data/output/consolidated",
