"""Central configuration: environment secrets + program/plan resolution.

Consolidates original ``config.py`` (GEMINI_API_KEY) and
``src/pipeline_config.py`` (program/plan discovery). No behavior change.
"""
