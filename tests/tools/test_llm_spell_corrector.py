...
from src.pipeline.tools.correction import corrector as llm_spell_corrector
...
class LlmSpellCorrectorTests(unittest.TestCase):
    ...
    def run_files(self, paths, responses, output_dir=None):
        ...
        with patch("src.pipeline.tools.correction.corrector.genai.Client", return_value=client):
