...
from src.pipeline.tools.merge.consolidator import merge_plan_with_description
from src.pipeline.tools.merge.consolidator import _apply_gened_audit_credit
from src.pipeline.tools.merge.consolidator import _recover_credit_from_matching_description
from src.pipeline.tools.merge.consolidator import _recover_gened_structural_credit
