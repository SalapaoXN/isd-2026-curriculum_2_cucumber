...
from src.pipeline.tools.merge.consolidator import merge_consecutive_files, merge_plan_with_description
from src.pipeline.tools.extraction.engine import CurriculumExtractor


ROOT = Path(__file__).resolve().parents[1]
OCR_OUTPUTS = ROOT / "reference" / "ocr"  # vendored read-only copy of original outputs/ocr/{dsba,it}
