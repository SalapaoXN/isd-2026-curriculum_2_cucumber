...
from src.pipeline.tools.extraction.tool import (
...
from src.pipeline.tools.ocr.pipeline_runner import main as run_pipeline_main, parse_pages
...
class CliSemanticsTests(unittest.TestCase):
    def test_run_pipeline_writes_ocr_only(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("src.pipeline.tools.ocr.pipeline_runner.parse_arguments", return_value=args), patch(
    ...
    def test_extract_legacy_summary_uses_legacy_destination(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("src.pipeline.tools.extraction.tool.parse_arguments", return_value=args), patch(
